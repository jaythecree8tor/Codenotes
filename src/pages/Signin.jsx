					...
					<div className='max-w-[550px] h-[700px] mx-auto border-[1px] border-[#ffffff02] rounded text-white'>
						<div className='max-w-[400px] mx-auto py-5'>
							...
							<form onSubmit={handleSumbit}>
								<h3 className='text-[#acb4ba] mb-2 px-3'>
									Sign In faster with
								</h3>
								<div className='mb-4 flex justify-between flex-wrap'>
									<div
										className='w-full strech px-1 '
								...
								<h3 className='text-[#acb4ba] px-3'>
									Or signin with your email
								</h3>

								{error ? (
									<p className='p-3 bg-[#cf44443a] my-2 rounded-lg border-[1px] border-[#ff949469]'>
										{error}
									</p>
								) : null}
								...
								<div className='my-3 in-cont px-3'>
									<input
										...
										className='form-control block py-4 px-3 w-full bg-[#121212] border-[1px] border-[#323232]'
										type='email'
										autoComplete='email'
										required='required'
									/>
								...
								<div className='mt-4 grid btn py-4 '>
									<button
										type='submit'
										className='w-full m-[4px] text-[14px] tracking-[1px] transition-all duration-300 align-middle rounded-[50px] px-4 py-[8px] btn-primary text-white'
									>
										Sign In
									</button>
								</div>
							...
							<div className='text-center'>
								<Link to='/signup' className='text-[14px]'>
									...
									<span className='  text-red-100'>Sign up</span>
								</Link>
							</div>
						</div>
					</div>
